...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default='./data/cached_train_record')
    ...
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default='./data/cached_dev_eval')
    parser.add_argument('--dev_logits_save_file',
                        type=str,
                        default=None)
    parser.add_argument('--test_eval_file',
                        type=str,
                        default='./data/cached_test_eval')
    parser.add_argument('--model_name',
                        type=str,
                        default='albert-base-v2',
                        help='name of the model, choose from albert-base-v2 albert-xxlarge-v2 albert_highway albert_highway albert_lstm_highway albert_bidaf albert_bidaf2')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--bidaf',
                        type=bool,
                        default=False,
                        help='Whether using the bidaf model, make sure to set it to true when using model which contains bidaf layers')
